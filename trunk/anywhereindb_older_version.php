...
// @abstract  the session has the login information 
{
	...
	{	
		...
		$tables = fetch_array($res);
             	...
             	// @abstract to search in only these tables uncomment this lines and 
                //$tables = array(
				// 					array('Tables_in_'.$dbname => 'table_name_1'),
				// 					array('Tables_in_'.$dbname => 'album'),
				// 					array('Tables_in_'.$dbname => 'user'),
				// 					array('Tables_in_'.$dbname => 'artist')
				//			);
		//endof table count
